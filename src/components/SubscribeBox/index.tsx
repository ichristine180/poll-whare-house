  ...
  return (
    <div className="bg-[#F9FAFB] rounded-lg p-6">
      <div className="text-center mb-4">
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-1">Subscribe To Updates!</h2>
        <p className="text-sm text-gray-600">
          Get the latest polls and trending topics delivered to your inbox.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto">
        <div className="flex gap-3">
          <input
            ...
            required
            className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white text-sm"
          />
          <button
            type="submit"
